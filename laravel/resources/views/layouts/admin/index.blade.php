            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Template</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><a href="{{route("admin.template.header")}}">Header</a></li>
                            <li><a href="{{route("admin.template.footer")}}">Footer</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><a href="{{route("admin.homePage.index")}}">Home</a></li>
                        ...
                        <a href="#" class="dropdown-toggle user-header" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            @if($user->image)
                                <div class="user-avatar">
                                    <img src="{{$define["PUBLIC_PATH"]}}{{$user->image}}" alt="avatar">
                                </div>
                            @endif
